...
function getCurrentTZ($available_languages,$available_timezones){
	if(!empty($_COOKIE['citizenroom']['bestlang'])){
		return $available_timezones[array_search($_COOKIE['citizenroom']['bestlang'],$available_languages)];
	}else return $available_timezones[0];
}
