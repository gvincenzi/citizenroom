...
<head>
	...
	<script src="../assets/js/jitsi_v25.js"></script>
			...
			$(function(){
				...
				.done(function( msg ) {
					...
					if(check.success == 'true'){
						...
						BindEvent('<?php echo $_SESSION['room_id']?>','<?php echo $_SESSION['nickname']?>',"<?php echo $_SESSION['room_title']?>","<?php echo $_SESSION['room_type']?>","<?php echo $_SESSION['room_country']?>");
